...
- Image (Currently only available in development version)
```r
library(excelR)
...
```
#### Getting/Setting comment in Shiny (Currently only available in development version)
```r
library(excelR)
library(shiny)
...
#### Getting selected data in Shiny  (Currently only available in development version)
