...
columns <- data.frame(title = colnames(data),
                      type = c("hidden", "dropdown", "calendar",  "image", "checkbox", "numeric", "color"),
                      width = c(120, 200, 200, 120, 80, 100, 100),
                      source = I(list(NA, c("Honda", "Alfa Romeo", "Audi", "Bmw"), NA, NA, NA, NA, NA)),
